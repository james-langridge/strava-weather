...
describe('ActivityProcessor Service', () => {
    ...
    const mockActivity: StravaActivity = {
        ...
        start_latlng: [52.5200, 13.4050], // Berlin coordinates
    ...
    beforeEach(() => {
        ...
        (stravaApiService.ensureValidToken as MockedFunction<any>).mockResolvedValue(mockTokenData);
        (stravaApiService.getActivity as MockedFunction<any>).mockResolvedValue(mockActivity);
        (stravaApiService.updateActivity as MockedFunction<any>).mockResolvedValue(mockActivity);
        (weatherService.getWeatherForActivity as MockedFunction<any>).mockResolvedValue(mockWeatherData);
    });
    ...
    describe('processActivity', () => {
        describe('successful processing', () => {
            it('should successfully process an activity with weather data', async () => {
                const result = await activityProcessor.processActivity('123456', 'user-123');
                ...
                expect(stravaApiService.getActivity).toHaveBeenCalledWith('123456', mockTokenData.accessToken);
            ...
            it('should handle token refresh when needed', async () => {
                ...
                (stravaApiService.ensureValidToken as MockedFunction<any>).mockResolvedValue(expiredTokenData);
            ...
            it('should preserve original description when adding weather', async () => {
                const originalDescription = 'Amazing run with friends! #running #fitness';
                const activityWithDesc = { ...mockActivity, description: originalDescription };

                (stravaApiService.getActivity as MockedFunction<any>).mockResolvedValue(activityWithDesc);
                ...
                expect(stravaApiService.updateActivity).toHaveBeenCalledWith(
                    ...
                    mockTokenData.accessToken,
                    {
                        description: expect.stringMatching(new RegExp(`^${originalDescription}\\n\\n`)),
                    }
                );
            });
        });
        ...
        describe('skip scenarios', () => {
            it('should skip when weather updates are disabled', async () => {
                ...
                (prisma.user.findUnique as MockedFunction<any>).mockResolvedValue(disabledUser);
            ...
            it('should skip when activity has no GPS coordinates', async () => {
                ...
                (stravaApiService.getActivity as MockedFunction<any>).mockResolvedValue(noGpsActivity);
            ...
            it('should skip when GPS coordinates are invalid', async () => {
                const invalidGpsActivity = { ...mockActivity, start_latlng: [52.5200] as any };
                (stravaApiService.getActivity as MockedFunction<any>).mockResolvedValue(invalidGpsActivity);
        ...
        describe('error handling', () => {
            ...
            it('should handle activity not found on Strava', async () => {
                (stravaApiService.getActivity as MockedFunction<any>).mockResolvedValue(null);
            ...
            it('should handle weather service errors', async () => {
                ...
                (weatherService.getWeatherForActivity as MockedFunction<any>).mockRejectedValue(weatherError);
            ...
            it('should handle Strava update errors', async () => {
                ...
                (stravaApiService.updateActivity as MockedFunction<any>).mockRejectedValue(updateError);
            ...
            it('should handle database errors during token update', async () => {
                ...
                (stravaApiService.ensureValidToken as MockedFunction<any>).mockResolvedValue(refreshedToken);
    ...
    describe('hasWeatherData', () => {
        const testCases = [
            ...
            { description: 'Rain, 15°C, Feels like 13°C, Wind 5m/s from NW', expected: true },
    ...
    describe('createWeatherDescription', () => {
        it('should create properly formatted weather description', () => {
            const result = (activityProcessor as any).createWeatherDescription(mockActivity, mockWeatherData);
        ...
        it('should handle missing original description', () => {
            ...
            const result = (activityProcessor as any).createWeatherDescription(activityNoDesc, mockWeatherData);
        ...
        it('should remove existing weather data before adding new', () => {
            ...
            const result = (activityProcessor as any).createWeatherDescription(activityWithOldWeather, mockWeatherData);
    ...
    describe('getWindDirectionString', () => {
        ...
        windDirectionTests.forEach(({ degrees, expected }) => {
            it(`should convert ${degrees}° to ${expected}`, () => {
                const result = (activityProcessor as any).getWindDirectionString(degrees);
                expect(result).toBe(expected);
            });
        });
    });
    ...
    describe('formatWeatherLine', () => {
        it('should format weather data with all fields', () => {
            const result = (activityProcessor as any).formatWeatherLine('Clear sky', mockWeatherData);
        ...
        it('should handle wind gust data when present', () => {
            ...
            const result = (activityProcessor as any).formatWeatherLine('Windy', weatherWithGust);
    ...
    describe('edge cases and race conditions', () => {
        ...
        it('should handle very long descriptions', async () => {
            ...
            (stravaApiService.getActivity as MockedFunction<any>).mockResolvedValue(longActivity);
        ...
        it('should handle special characters in weather description', () => {
            ...
            const result = (activityProcessor as any).createWeatherDescription(mockActivity, specialWeather);
        ...
        it('should handle timezone differences in activity time', async () => {
            ...
            (stravaApiService.getActivity as MockedFunction<any>).mockResolvedValue(timezoneActivity);
    ...
    describe('performance considerations', () => {
        ...
        it('should handle network timeouts gracefully', async () => {
            ...
            (weatherService.getWeatherForActivity as MockedFunction<any>).mockRejectedValue(timeoutError);
